...
QT_MOC_LITERAL(1, 6, 13), // "show_set_page"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 12) // "close_window"

    },
    "title\0show_set_page\0\0close_window"
};
...
void title::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&title::show_set_page)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&title::close_window)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void title::show_set_page()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void title::close_window()
{
